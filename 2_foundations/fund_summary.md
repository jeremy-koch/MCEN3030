...
1. Create a vector with 50 elements, equally spaced between 0 and 4?
2. Create a vector of random numbers between 2 and 3?
3. Plot $f(x)=x(3-x)$ with a continuous line?
4. Add random noise from a normal distribution to a line $f(x)=mx+b$? (With a known mean and variance.)
5. 
