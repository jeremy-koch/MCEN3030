...
Your instructors are not naïve. We are aware that AI use is widespread among students. That alone is not necessarily an issue, it is MISuse that is concerning -- specifically, we worry that students are not actually developing as engineers. The point of homework is to develop as an engineer!
...
:::{aside}
Not to be all "when I was your age, I had to walk to school uphill both ways, in the snow", but when I was an undergrad it was typical for homework to be worth 10% of the overall grade. I don't really believe that two or three time-constrained exams are a perfect indicator of a student's level of mastery of the content, but the widespread misuse of AI on homework has basically made it so that homework grades are meaningless. So engineering departments are trending back towards exam-heavy classes.
:::
