...
For better or worse, AI is here and, at least for now, is extremely accessible. I could write many thousands of words on why this is not necessarily a good thing for students. Most notably: Who is going to hire an engineer who has outsourced all their thinking to AI? If I was interviewing a recent grad and they ran to ChatGPT for even simple things like "what is the Reynolds Number", I would end the interview immediately. I wouldn't care that the information was indeed readily available on ChatGPT, I am looking for someone who is comfortable with engineering, who can see the connections, who can troubleshoot problems, and who I'd feel excited to work with. "Hold on, let me see what ChatGPT says"... I can ask ChatGPT too, thanks for stopping by.
