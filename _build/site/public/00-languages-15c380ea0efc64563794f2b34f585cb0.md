...
- I find it annoying that the default is to print every line and a ```;``` must be added to prevent that. It would have been cooler if ```;``` printed the line -- what a succinct bit of code! But they didn't ask me.
