...
:::{aside}
I am hearing stories about students in tech electives/senior design who are running code, writing down the output on a piece of paper, changing the code and rerunning, writing that result down, changing the code and rerunning, writing that result down, ... . Didn't know how to add the three or fours lines to automate this entirely. I feel embarrassed that these students might have passed my 3030 class.
:::
