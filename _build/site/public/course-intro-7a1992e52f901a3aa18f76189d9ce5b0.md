...
:::{warning}
The exams in this course make up most of the grade, and they are pencil and paper with no electronics. Understanding the inputs, outputs, and limitations of the functions, as well as having knowledge about the basic components within them, is the way to succeed on the exams. Asking AI to do your homework for you is a recipe for a bad exam experience!
:::
