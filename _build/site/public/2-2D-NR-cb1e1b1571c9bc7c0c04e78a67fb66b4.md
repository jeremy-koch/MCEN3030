...
The process of finding a matrix inverse is not trivial, though with the convenience of modern programming it seems easy. The next unit of the class will focus on problems that can be frames via matrix equations.
