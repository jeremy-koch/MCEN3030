...
Students are assessed based on the work that they have submitted over the course of the semester. You should assume that there is no extra credit in this class (other than the email professionalism few points) -- if any is made available, it will be small (think: an extra in-class assignment that can replace a missing one) and made available to the entire class. Do not ask about extra credit.
