...
- and we have an "AI green light" on homework assignments, which you should not [misuse](), but it helps to enable this "polyglot" approach to the course.
...
:::{tip}
In the grand scheme of things, these languages are very similar, using ```index:slicing```, ```for```, ```while```, etc. You will be able to understand each other's code
:::
