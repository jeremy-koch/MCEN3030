...
:::{aside}
The machine learning project will, of course, require a ton more code, though that project will be more practical -- I don't understand all the nuances of it, there is an entire course devoted to it.
:::
