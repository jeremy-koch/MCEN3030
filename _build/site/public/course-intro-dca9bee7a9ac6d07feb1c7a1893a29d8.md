...
- We will do a machine learning project. Broadly speaking, machine learning is about giving a computer a training data set, from which it methodically identifies patterns, and then uses that information to predict things about new data. A classic example is to give the program a picture and ask "is this an apple?" If it has been trained on a robust data set, it will get it right 90+% of the time.
