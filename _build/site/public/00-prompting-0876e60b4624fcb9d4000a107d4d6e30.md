...
:::{warning}
The thing that students need to realize is that understanding an answer is very different from being able to produce an answer. I suspect many students ask LLMs to produce an answer, then they "study" it, and then think they "understand" the problem. That is basically never the case.
