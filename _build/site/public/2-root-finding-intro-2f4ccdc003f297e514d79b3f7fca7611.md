...
- You may need to do some prep work, e.g. calculating a derivative or rearranging $f(x)=0$ to something slightly different, a $g(x)=0$ (e.g., dividing the original equation by $x$).
...
:::{aside}
Higher dimensions too, but I don't want to write it out!
:::
