...
- You can choose what language you use (perhaps with some limits). If you really enjoy C++, you can use it. If you want to go with a language you will (probably) see in Data Analysis and System Dynamics, think about MATLAB. If you are a bit adventurous, try this new language called Julia. AI will help us!
