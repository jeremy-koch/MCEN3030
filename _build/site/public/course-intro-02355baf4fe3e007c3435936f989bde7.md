...
- Because this is a "{abbr}`polyglot (many languages)`" course, most of the times that code is referenced, it will be included in an environment like that below. You can choose the tab for your language, then see the code. In the top-right corner of each coding environment, you can choose an icon to copy that code block, and then you can paste it into your working environment and run it. Please understand that it was a big undertaking to include this feature, and there may be some small mistakes in the code! Confirm it does what you think it does!
- In the top-right corner of this site is a search bar. So, if you are looking for references to _Taylor Series_, you can search for it up there. It will return instances from within this site.
