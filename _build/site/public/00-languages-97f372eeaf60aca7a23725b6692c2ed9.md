...
No matter what language you choose, you should be prepared to KNOW things like: whether indexing starts with 0 or 1, how to find the ```length``` of an array, how to write a ```for``` loop. On the exams, forgetting that Python indexes from 0 or that MATLAB requires an ```end``` at the end of its loops will lose you points. Do not ask for leniency -- I am empowering you to learn and use whatever language you want, so learn it!
