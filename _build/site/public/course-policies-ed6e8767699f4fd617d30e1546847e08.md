...
:::
:::{warning}
The instructional staff will monitor GitHub commits that occur Tu/Th at ~12:15 and ~1:45PM, i.e., at the end of class periods. If we see that the two sections are, on average, not making use of the in-class time (as evidenced by a low percentage of students committing something at the end of class), we will eliminate this working opportunity and replace it with additional in-class work or lecture content. 
:::
