...
:::{aside}
A $5\times 5$ matrix is not even "large", yet solving the fifth-degree polynomial is impossible for a human and not straightforward for a computer either. In many applications, the matrix in question is even larger, maybe much larger, and there is no hope of finding the polynomial roots!
:::
