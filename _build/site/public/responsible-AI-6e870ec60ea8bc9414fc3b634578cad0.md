...
Your instructors are aware that AI use is widespread among students. It is misuse that we are concerned about -- specifically, we worry that students are not actually developing as engineers.
:::{aside}
