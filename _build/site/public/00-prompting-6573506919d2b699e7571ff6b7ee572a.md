...
This does not mean that LLMs are there to help you learn: if you want to learn, you must be more thoughtful about how you interact with them. So here are my recommendations on how to responsibly use AI, if your goal is to actually learn:
