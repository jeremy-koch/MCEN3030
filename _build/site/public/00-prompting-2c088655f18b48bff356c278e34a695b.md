...
- If you encounter a cryptic error message, again: try to decipher it on your own, and if you can't figure it out, ask and be specific. "I get the following error: \<whatever the error is\>. It seems to be related to .
