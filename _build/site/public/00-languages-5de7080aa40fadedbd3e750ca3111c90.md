...
- Choose C++ if already have some experience with it and enjoy it (e.g.~from CSCI 1300). I don't think any language will prohibit you from working with robots in the future, but C++ is probably the one most associated with robotics.

I would guess 80% of the class will choose MATLAB, 15% will choose Python, and 5% will choose Julia/C++/other.



No matter what language you choose, you should be prepared to KNOW things like: whether indexing starts with 0 or 1, how to find the ```length``` of an array, how to write a ```for``` loop, the character used for comments. On the exams, forgetting that Python indexes from 0 or that MATLAB requires you to ```end``` loops will lose you points. Do not ask for leniency if you make these mistakes -- I am empowering you to learn and use whatever language you want, so learn it!
