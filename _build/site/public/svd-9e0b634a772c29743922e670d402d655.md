...
:::{attention}
The image itself is still $3024\times 4032$, and so saving it in the "naive" way, with individual pixel intensities, does not actually help us. Meanwhile: $\mathbf{U}$ goes from $3024\times 3024$ to $3024\times 100$, $\mathbf{S}$ goes from $3024\times 4032$ to $100\times 100$, and $\mathbf{V}$ goes from $4032\times 4032$ to $4032\times 100$, 
:::
