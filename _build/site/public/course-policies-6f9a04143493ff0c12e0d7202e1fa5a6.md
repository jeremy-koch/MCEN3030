...
A slight curve may be applied to exam grades or the overall grade, but this is not guaranteed. I have not applied a curve to my 3000-level classes in a while. Again, you should not ask: should a curve be applied to any aspect of the class, it will be small (think: +2 points to an exam where the average was a 75) and will be applied.
