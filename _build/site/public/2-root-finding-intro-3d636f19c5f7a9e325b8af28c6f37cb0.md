...
- You may need to do some prep work, e.g. calculating a derivative or rearranging $f(x)=0$ to something slightly different.
...
:::{aside}
Higher dimensions too, I guess, but I don't want to write it out!
:::
