...
If you are interested, you can read about [Bloom's Taxonomy](https://en.wikipedia.org/wiki/Bloom%27s_taxonomy), which is a framework for understanding how students master a topic. Reading LLM solutions may help you with "knowledge" and "comprehension", the lower levels of the taxonomy ("Ah that is how to format the inputs"). It will not help you get better at the "application", "analysis", "synthesis", or "evaluation" levels. This far into your engineering education, those are the things that matter.
:::
