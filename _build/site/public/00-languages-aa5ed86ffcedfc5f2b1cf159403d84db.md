...
TL;DR:
- Choose MATLAB if you want the easiest installation, and if you want to just get some direct, explicit experience with a l
- Choose Python if you care to use something open-source but still popular. Also if you are interested in machine learning, it is probably the most robust.
- Choose Julia if you are a bit adventurous and want to try a "real" programming language that was developed for scientists and engineers.
